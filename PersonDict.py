...
class PersonDict(object):
    ...
    crime_synonym = ['ГРАБИТЕЛЬ', "ГРАБИТЕЛИ", "ПОДОЗРЕВАЕМЫЙ", "МОШЕННИК", "НАРКОТОРГОВЕЦ", "ОБВИНЯЕМЫЙ", "ПРЕСТУПНИК",
                     ...
                     "ГЛАВАРЬ ГРУППИРОВКИ КИЛЛЕРА", "ХУЛИГАН", "ВЕДУЩИЙ МАФИОЗНЫЙ КАВКАЗСКИЙ КЛАН", "ЗЛОУМЫШЛЕННИК", "ВИНОВНИК ГИБЕЛИ",
                     "МЕСТНЫЙ РАЗБОЙНИК", "ОБНАГЛЕВШАЯ ШПАНА"]
    police_synonym = ['СОТРУДНИК', 'СТРАЖА', "СОТРУДНИК ПОЛИЦИИ", "СЫЩИК", "СЛЕДОВАТЕЛЬ", "ИСПАНСКИЙ СЫЩИК",
                      ...
                      "ЗАМНАЧАЛЬНИКА КРИМИНАЛЬНОЙ ПОЛИЦИИ СИГУЛДА", "МИЛИЦИОНЕР", "СОТРУДНИК"]
    ...
    crime_relations = ['УБИТЬ', "УКРАСТЬ", "ЗАРЕЗАЛ", "УБИЛ", "УКРАЛ", "НАНЕС", "УДАРИЛ"]
    victim_relations = ["СКОНЧАЛАСЬ"]
